...
public class Ascii extends JOGLBase implements KeyListener {
   ...
   //public String fname = "C:\\Users\\Daniel\\Pictures\\IMG_4202.jpg";
   //public char[] symbols =  new char[]{ ' ', '.', ';', '$', '*', 'X', '8', '@', '~', '_', '&', '/', '|' };
   //public String[] symbols =  new String[]{ " ", ".", ";", "$", "*", "X", "8", "@", "~", "_", "&", "/", "|" };
   ...
   public void display(GLAutoDrawable a) {
      ...
      textureData2 = TextureIO.newTextureData(gl2.getGLProfile(),  f, false, null);
   ...
   public void loadTexture(GL2 gl2) {
      try {
         ...
         //File file = new File(dirStr + s[index]);
         //File file = new File(dirStr + "test.gif");
